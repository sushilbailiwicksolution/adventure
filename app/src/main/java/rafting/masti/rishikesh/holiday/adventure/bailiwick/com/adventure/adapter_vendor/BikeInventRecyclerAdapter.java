...
public class BikeInventRecyclerAdapter extends RecyclerView.Adapter<BikeInventRecyclerAdapter.ViewHolder> {

    private Context context;
    private List<BikeInventoryBeans> campInventoryListBeanList;

    private BikeInventRecyclerAdapter.ItemClickMasterMenuListInterface itemClickListener;

    public interface ItemClickMasterMenuListInterface {
        void onItemMasterClick(int position);
    }

    public BikeInventRecyclerAdapter(Context context, List<BikeInventoryBeans> cartListBeanList, BikeInventRecyclerAdapter.ItemClickMasterMenuListInterface itemClickRecListInterface) {
    ...
    @Override
    public BikeInventRecyclerAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        String dayDate = campInventoryListBeanList.get(holder.getAdapterPosition()).getStr_date() + " " + campInventoryListBeanList.get(position).getStr_day();
        ...
        holder.txt_Type_text.setText("Bike Status");
