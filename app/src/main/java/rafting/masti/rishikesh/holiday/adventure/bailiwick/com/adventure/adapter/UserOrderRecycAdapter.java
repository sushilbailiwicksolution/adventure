...
public class UserOrderRecycAdapter extends RecyclerView.Adapter<UserOrderRecycAdapter.ViewHolder> {

    Context context;
    private List<Order_Beans> orderHistoryList;

    public UserOrderRecycAdapter(Context context, List<Order_Beans> orderHistoryList) {
