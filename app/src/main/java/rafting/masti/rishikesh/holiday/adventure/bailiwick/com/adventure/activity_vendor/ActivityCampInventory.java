...
import rafting.masti.rishikesh.holiday.adventure.bailiwick.com.adventure.adapter.CampInventRecyclerAdapter;
...
public class ActivityCampInventory extends RootActivity implements CampInventRecyclerAdapter.ItemClickMasterMenuListInterface {
    ...
    CampInventRecyclerAdapter campInventRecyclerAdapter;
...
//                                        raftingPoint_list.add("Select Point");
                    ...
                    try {
                        ...
                        if (response != null) {
                            ...
                            if (status.equalsIgnoreCase("1")) {
                                ...
                                campInventRecyclerAdapter.notifyDataSetChanged();
                            } else {
                                String msg = jsData.getString("msg");
                                Toast.makeText(context, msg, Toast.LENGTH_LONG).show();
                            }
    ...
    private void createIDS() {
        ...
        campInventRecyclerAdapter = new CampInventRecyclerAdapter(context, camp_inventoryList, this);
        ...
        recyclerViewCamp_inventory.setAdapter(campInventRecyclerAdapter);
    ...
    public void onItemMasterClick(int position) {
        ...
        Intent i = new Intent(ActivityCampInventory.this, ActivityCampControl.class);
        i.putExtra("select_date", camp_inventoryList.get(position).getStr_date());
        i.putExtra("camp_ID", campListID.get(spinner_Select_camp.getSelectedItemPosition() - 1));
        i.putExtra("camp_name", spinner_Select_camp.getSelectedItem().toString());
