...
public class PaymentHistoryAdapter extends RecyclerView.Adapter<PaymentHistoryAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if (!paymentHistory.getOrderDate().isEmpty() && paymentHistory.getOrderDate() != null){
            ...
            SimpleDateFormat recievedFormat = new SimpleDateFormat("yyyy-MM-dd hh:mm:ss",Locale.getDefault());
            try {
        ...
        if (!paymentHistory.getOrderAmount().isEmpty() && paymentHistory.getOrderAmount() != null){
            String orderAmount = "Rs. "+paymentHistory.getOrderAmount();
            holder.textOrderAmount.setText(orderAmount);
        }
