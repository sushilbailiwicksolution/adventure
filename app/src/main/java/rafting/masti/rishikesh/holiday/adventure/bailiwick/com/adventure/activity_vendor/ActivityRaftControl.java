...
public class ActivityRaftControl extends RootActivity {
    ...
    private void createIDS() {
        mContext = ActivityRaftControl.this;

        txt_Check_in = findViewById(R.id.txt_booking_date);
        txt_starting_point = findViewById(R.id.txt_starting_point);
        ...
        rgp_raft_control = findViewById(R.id.rgp_raft_control);
        rdb_open_raft = findViewById(R.id.rdb_open_raft);
        rdb_close_raft = findViewById(R.id.rdb_close_raft);
    }
