...
public class ProductListBean {
    private String Str_package_id, Str_package_name, Str_service_name, Str_service_id,
            Str_short_description, Str_description, Str_country, Str_city, Str_state, Str_price, Str_image, Str_status;
    private boolean ISNight;

    public ProductListBean(String str_package_id, String str_package_name, String str_service_name, String str_service_id, String str_short_description, String str_description, String str_country, String str_city, String str_state, String str_price, String str_image, String str_status, boolean isNight) {
