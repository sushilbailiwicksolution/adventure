...
public class CampViewActivity extends RootActivity implements View.OnClickListener {
                    ...
                    try {
                        ...
                        if (response != null) {
                            ...
                            if (status.equalsIgnoreCase("1")) {
                                ...
                                mPager.setAdapter(new ImageUrlSliderAdapter(productArray, CampViewActivity.this));
...
//                                        final Handler handler = new Handler();
    ...
    private void getUiObject() {
        ...
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(CampViewActivity.this, LinearLayoutManager.HORIZONTAL, false);
...
*/
    ...
    private void campBookingForm(final String action) {
        ...
        final CampBookinDialog campBooking = new CampBookinDialog(CampViewActivity.this, jsResponse, camp_id);
        campBooking.btn_cancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DbFunction.ExportDatabasee(context, DbUtils.DB_NAME);
                campBooking.dismiss();
            }
        });
        campBooking.btn_Apply.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (str_check_in.equalsIgnoreCase("check In")) {
                    ...
                    int EntryExist = DbOperation.getRaftCount(CampViewActivity.this, camp_id);
                    if (EntryExist > 0) {
                        DbOperation.deleteCartItem(CampViewActivity.this, camp_id);
                    }
                    ...
                    if ((Objects.requireNonNull(date_check_in).compareTo(date_check_out)) < 0 /*|| (date_check_in.compareTo(date_check_out)==0)*/){
                        isSuccess = DbOperation.insertCampaningCart(CampViewActivity.this,
                    ...
                    if (isSuccess) {
                        Toast.makeText(CampViewActivity.this, "Saved in Database", Toast.LENGTH_SHORT).show();
                        //DB_Function.ExportDatabasee(getActivity(), DbUtils.DB_NAME);
                       // int cartCount = DbOperation.getRaftCount(CampViewActivity.this, camp_id);
                        int cartCount = Objects.requireNonNull(DbOperation.getCartList(CampViewActivity.this)).size();
                        ...
                        if (action.equalsIgnoreCase("book_now")) {
                            Intent i = new Intent(CampViewActivity.this, CartList.class);
                            startActivity(i);
                            finish();
                        } else if (action.equalsIgnoreCase("cart")) {
                            Intent homeIntent = new Intent(CampViewActivity.this, HomePage.class);
                            homeIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                            startActivity(homeIntent);
                            finish();
                        }
